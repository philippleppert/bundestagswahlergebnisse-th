...
data_raw <- read_delim("data_preparation/mod_data/th_bw_2021.csv", delim = ";", col_names = F,
                       na = c("", "-")) %>%
  `colnames<-`(c("Stand",
                 "Satzart",
                 "Wahlkreisnr.",
                 ...
                 "Erststimme_absolut_DIE_PARTEI",
                 "Erststimme_prozent_DIE_PARTEI",
                 "Zweitstimme_absolut_DIE_PARTEI",
                 "Zweitstimme_prozent_DIE_PARTEI",
                 "Erststimme_absolut_NPD",
                 "Erststimme_prozent_NPD",
                 "Zweitstimme_absolut_NPD",
                 "Zweitstimme_prozent_NPD",
                 "Erststimme_absolut_ÖDP",
                 "Erststimme_prozent_ÖDP",
                 "Zweitstimme_absolut_ÖDP",
                 "Zweitstimme_prozent_ÖDP",
                 "Erststimme_absolut_PIRATEN",
                 "Erststimme_prozent_PIRATEN",
                 "Zweitstimme_absolut_PIRATEN",
                 "Zweitstimme_prozent_PIRATEN",
                 "Erststimme_absolut_VPARTEI",
                 "Erststimme_prozent_VPARTEI",
                 "Zweitstimme_absolut_VPARTEI",
                 "Zweitstimme_prozent_VPARTEI",
                 "Erststimme_absolut_MLPD",
                 "Erststimme_prozent_MLPD",
                 "Zweitstimme_absolut_MLPD",
                 "Zweitstimme_prozent_MLPD",
                 "Erststimme_absolut_Basis",
                 "Erststimme_prozent_Basis",
                 "Zweitstimme_absolut_Basis",
                 "Zweitstimme_prozent_Basis",
                 "Erststimme_absolut_Menschliche_Welt",
                 "Erststimme_prozent_Menschliche_Welt",
                 "Zweitstimme_absolut_Menschliche_Welt",
                 "Zweitstimme_prozent_Menschliche_Welt",
                 "Erststimme_absolut_Humanisten",
                 "Erststimme_prozent_Humanisten",
                 "Zweitstimme_absolut_Humanisten",
                 "Zweitstimme_prozent_Humanisten",
                 "Erststimme_absolut_Tierschutzpartei",
                 "Erststimme_prozent_Tierschutzpartei",
                 "Zweitstimme_absolut_Tierschutzpartei",
                 "Zweitstimme_prozent_Tierschutzpartei",
                 "Erststimme_absolut_Team_Todenhöfer",
                 "Erststimme_prozent_Team_Todenhöfer",
                 "Zweitstimme_absolut_Team_Todenhöfer",
                 "Zweitstimme_prozent_Team_Todenhöfer",
...
daten_2021 <- bind_rows(l_analyse, k_analyse, lk_analyse, g_analyse, ot_analyse)
