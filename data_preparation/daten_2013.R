...
key_kreise <- read_delim("data_preparation/mod_data/keys_lk.csv", 
                         delim = ";",
                         col_types = "cc")


data_raw <- read_delim("data_preparation/mod_data/th_bw_2013.csv", delim = ";", 
                       col_names = F, col_types =cols(X12 = col_character()),
                       na = c("", "-")
                       ) %>%
  `colnames<-`(c("Stand",
                 "Satzart",
                 ...
                 "Erststimme_absolut_REP",
                 "Erststimme_prozent_REP",
                 "Zweitstimme_absolut_REP",
                 "Zweitstimme_prozent_REP",
  ...
  mutate(Id = str_c(Wahlkreisnr., Kreisnr., Gemeindenr., Wahlbezirksnr.),
         Jahr = 2013,
         Wahlbeteiligung = as.numeric(gsub(",","\\.",.$Wahlbeteiligung))
         ) %>%
...
daten_2013 <- bind_rows(l_analyse, k_analyse, lk_analyse, g_analyse, ot_analyse)
