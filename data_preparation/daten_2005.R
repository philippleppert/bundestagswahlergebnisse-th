...
data_raw <- read_delim("data_preparation/mod_data/th_bw_2005.csv", delim = ";", 
  ...
  `colnames<-`(c("Stand",
                 ...
                 "Erststimme_absolut_GRAUE",
                 "Erststimme_prozent_GRAUE",
                 "Zweitstimme_absolut_GRAUE",
                 "Zweitstimme_prozent_GRAUE",
...
daten_2005 <- bind_rows(l_analyse, k_analyse, lk_analyse, g_analyse, ot_analyse)
