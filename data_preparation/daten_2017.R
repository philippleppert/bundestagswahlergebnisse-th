...
data_raw <- read_delim("data_preparation/mod_data/th_bw_2017.csv", delim = ";", col_names = F,
                       na = c("", "-")) %>%
  `colnames<-`(c("Stand",
                 "Satzart",
                 "Wahlkreisnr.",
                 ...
                 "Erststimme_absolut_BGE",
                 "Erststimme_prozent_BGE",
                 "Zweitstimme_absolut_BGE",
                 "Zweitstimme_prozent_BGE",
                 "Erststimme_absolut_DM",
                 "Erststimme_prozent_DM",
                 "Zweitstimme_absolut_DM",
                 "Zweitstimme_prozent_DM",
                 ...
                 "Erststimme_absolut_Einzelbewerber3",
                 "Erststimme_prozent_Einzelbewerber3"
                 )
  ) %>%
...
daten_2017 <- bind_rows(l_analyse, k_analyse, lk_analyse, g_analyse, ot_analyse)